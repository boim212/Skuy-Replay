              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    ...
                    <h1 class="h4 text-gray-900 mb-4">Sign In | Administrator</h1>
                  </div>
                  @if(session('errors'))
                  ...
                  <form class="user" action="{{ route('login') }}" method="post">
                    ...
                    <div class="form-group">
                    <button type="submit button" class="btn btn-primary btn-block">Login</button>
                    </div>
                    <hr>
                    <a href="/forget-pass" class="btn btn-google btn-block">
                      <i class="fab fa-google fa-fw"></i> Forgot Your Password?
                    </a>
                  </form>
                  <hr>
                  <div class="text-center">
